       ...
       <div class="row pt-5">
           <div class="col-lg-3 col-md-6 mb-5">
               ...
               <div class="d-flex justify-content-start mt-4">
                   ...
                   <a class="btn btn-outline-light rounded-circle text-center mr-2 px-0" style="width: 40px; height: 40px;" href="https://www.facebook.com/profile.php?id=100009145945055"><i class="fab fa-facebook-f"></i></a>
                   <a class="btn btn-outline-light rounded-circle text-center mr-2 px-0" style="width: 40px; height: 40px;" href="https://www.linkedin.com/in/jitendra-pawar-24b1a8178"><i class="fab fa-linkedin-in"></i></a>
           ...
           <div class="col-lg-3 col-md-6 mb-5">
               ...
               <p><?= date('h:i a', strtotime($detail['open_time'])); ?> - <?= date('h:i a', strtotime($detail['closing_time'])); ?></p>
           </div>
       </div>
       <div class="container border-top border-dark pt-5">
           <p class="m-0 text-center text-white">
               &copy; <a class="text-white font-weight-bold" href="#">Fitness Club</a>. All Rights Reserved. Developed by
