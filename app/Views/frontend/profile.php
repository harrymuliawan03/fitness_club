         ...
         <div class="container d-flex justify-content-center align-items-center">
            <div class="card">
               ...
               <div class="user text-center">
                  <div class="profile">
                  <?php if (session()->get('current_weight') ==NULL) { ?>
                           <img src="<?= session()->get('file'); ?>" class="rounded-circle" width="80">
                  <?php }else { ?>
               ...
               <div class="mt-5 text-center">
                  <h4 class="mb-0"><?= session()->get('fullname'); ?></h4>
                  <span class="text-muted mb-2"><?= session()->get('gender'); ?></span>, <span class="text-muted  mb-2"><?= session()->get('age'); ?></span>
                  <div class="mt-3">
                    <?php if (session()->get('current_weight') ==NULL) { ?>
                      <a href="<?= base_url('home/edit_social_login/');  ?>"><button class="btn btn-sm follow font-weight-bold text-uppercase">Edit</button></a>
                    <?php }else{ ?>
