                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 log-det">
                            ...
                            <div class="mb-3">
                                ...
                                <a href="<?= base_url('payment/pay_membership'); ?>"
                                    class="btn btn-success btn-round text-white">Proceed to Pay</a>
                                <?php } ?>
                            </div>
                            <form method="post" action="<?= base_url('home/login'); ?>">
                                <div class="text-box-cont">
                                    ...
                                    <div class="text-danger mb-3">
                                        <?php if(isset($form_error) && $form_error->hasError('username')){ echo $form_error->getError('username');} ?>
                                    </div>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon1"><i
                                    ...
                                    <div class="text-danger mb-3">
                                        <?php if(isset($form_error) && $form_error->hasError('pass')){ echo $form_error->getError('pass');} ?>
                                    </div>
                                    ...
                                    <div class="row">
                                        <p class="forget-p">Forget Password? <a href="" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal"><span id="reset-password">Reset
                                                    Password</span></a></p>
                                    </div>
                                    <div class="row">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header text-danger">
                    <h1></h1>
                    <h4 class=""><i class="fa-solid fa-dumbbell"></i> Fitness Club Verification</h4>
                    <h2></h2>
                </div>
