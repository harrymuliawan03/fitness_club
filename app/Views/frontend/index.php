        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    ...
                    <h2 class="display-2 m-0 mt-2 mt-md-4 text-white font-weight-bold text-capitalize">Best Gym In Town
                    </h2>
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <h3 class="text-primary text-capitalize m-0">Gym & Fitness Center</h3>
                    <h2 class="display-2 m-0 mt-2 mt-md-4 text-white font-weight-bold text-capitalize">Get Body In Shape
                    </h2>
                    <a href="<?= base_url('home/membership'); ?>"
                        class="btn btn-lg btn-outline-light mt-3 mt-md-5 py-md-3 px-md-5">Join Us Now</a>
                </div>
    ...
    <div class="row px-3">
        <div class="col-md-6 p-0">
            <div
                ...
                <a href="<?php echo base_url('home/membership'); ?>" class="btn btn-lg btn-outline-light mt-4 px-4">Join
                    Now</a>
            </div>
        </div>
        <div class="col-md-6 p-0">
            <div
                ...
                <a href="<?= base_url('home/membership'); ?>" class="btn btn-lg btn-outline-light mt-4 px-4">Join
                    Now</a>
            </div>
        </div>
    </div>
...
<div class="container feature pt-5">
    ...
    <div class="row">
        <div class="col-md-6 mb-5">
            <div class="row align-items-center">
                <div class="col-sm-5">
                    <img class="img-fluid mb-3 mb-sm-0" src="<?= base_url('assets/frontend'); ?>/img/feature-1.jpg"
                        alt="Image">
        ...
        <div class="col-md-6 mb-5">
            <div class="row align-items-center">
                <div class="col-sm-5">
                    <img class="img-fluid mb-3 mb-sm-0" src="<?= base_url('assets/frontend'); ?>/img/feature-2.jpg"
                        alt="Image">
        ...
        <div class="col-md-6 mb-5">
            <div class="row align-items-center">
                <div class="col-sm-5">
                    <img class="img-fluid mb-3 mb-sm-0" src="<?= base_url('assets/frontend'); ?>/img/feature-3.jpg"
                        alt="Image">
        ...
        <div class="col-md-6 mb-5">
            <div class="row align-items-center">
                <div class="col-sm-5">
                    <img class="img-fluid mb-3 mb-sm-0" src="<?= base_url('assets/frontend'); ?>/img/feature-4.jpg"
                        alt="Image">
...
<div class="subscribe container-fluid my-5 py-5 ">
    ...
    <a href="<?php echo base_url('home/membership'); ?>"
        class="btn btn-lg btn-outline-light mt-3 mt-md-5 py-md-3  px-md-5">Join Us Now</a>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-6 mb-5">
            <div class="card border-0 bg-secondary text-center text-white">
                <img class="card-img-top" src="<?= base_url('assets/backend/images/'.$value['img']); ?>"
                    alt="Trainer pic">
                    ...
                    <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active">
                                <div class="d-flex align-items-center mb-4 text-white">
                                    <img width="80" height="80" class="rounded-circle bg-dark p-2"
                                        src="<?= base_url('assets/frontend'); ?>/img/testimonial-1.jpg" alt="Image">
                                    <div class="pl-4">
                            ...
                            <div class="carousel-item">
                                <div class="d-flex align-items-center mb-4 text-white">
                                    <img width="80" height="80" class="rounded-circle bg-dark p-2"
                                        src="<?= base_url('assets/frontend'); ?>/img/testimonial-2.jpg" alt="Image">
                                    <div class="pl-4">
                                        <h4 class="text-primary">Client Name</h4>
                                        <p class="m-0">Profession</p>
                                    </div>
                            ...
                            <div class="carousel-item">
                                <div class="d-flex align-items-center mb-4 text-white">
                                    <img width="80" height="80" class="rounded-circle bg-dark p-2"
                                        src="<?= base_url('assets/frontend'); ?>/img/testimonial-3.jpg" alt="Image">
                                    <div class="pl-4">
                                        <h4 class="text-primary">Client Name</h4>
                                        <p class="m-0">Profession</p>
                                    </div>
...
<div class="container pt-5">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 mb-5 blog-item">
            <div class="text-center"><img class="img-fluid mb-4"
                    src="<?= base_url('assets/backend/images/'.$value['img']); ?>" alt="Image"></div>
            ...
            <a class="btn btn-outline-primary mt-2 px-3" href="<?= base_url('blogs/read/'.$value['id']);  ?>">Read More
