                  ...
                  <table class="table table-hover table-bordered">
                    ...
                    <tbody class="text-center">
                      ...
                      <tr>
                        ...
                        <td><a href="<?= site_url('contact/delete/').$value['id']; ?>"><button class="btn btn-danger delete-mail btn-sm" value="<?= $value['id']?>">Delete</button></a></td>
                      </tr>
                    <?php } ?>
                    </tbody>
                  </table>
                </div>
                <?php $pager->setPath('fitness_club/Contact/enquiries'); ?>
                <?= $pager->links_4(); ?>
              </div>
            </div>
          </div>
