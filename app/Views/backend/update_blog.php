<div class="main-panel">
  <div class="content-wrapper">
    <div class="col-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title text-center">Edit Blogs here</h4>
            ...
            <div class="container">
              <div class="row">
                <div class="form-group col-md-12">
                  <label for="exampleInputEmail3">Bloger Name</label>
                  <select class="form-control" name="bloger_name">
                    <option value="<?= $data['bloger_name']; ?>"><?= $data['bloger_name']; ?></option>
                    <?php foreach ($admin_name as $bloger): ?>
                      <option value="<?= $bloger['fullname']; ?>"><?= $bloger['fullname'] ?></option>
                      <?php endforeach; ?>
                  </select>
                </div>
                <div class="form-group col-md-12">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="datetime-local" class="form-control" name="date" value="<?= date('m/d/Y H:i A', strtotime($data['date']));  ?>"/>
