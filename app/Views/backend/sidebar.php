...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
    <a class="sidebar-brand brand-logo text-decoration-none" href="<?= base_url('admin/dashboard');  ?>"><h3 class="text-white text-uppercase fw-bold mt-4 ms-2">Fitness Club</h3></a>
    <a class="sidebar-brand brand-logo-mini text-decoration-none ms-3 mt-4" href="<?= base_url('admin/dashboard');  ?>"><h3 class="text-white text-uppercase fw-bold">FC</h3></a>
  </div>
  <ul class="nav">
    ...
    <li class="nav-item menu-items">
      ...
      <div class="collapse" id="members">
        ...
        <li class="nav-item"> <a class="nav-link mb-2" href="<?= base_url('Members/sm_login'); ?>"><span><i class="mdi mdi-account-circle me-2"></i></span>Social Media Login</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item menu-items">
